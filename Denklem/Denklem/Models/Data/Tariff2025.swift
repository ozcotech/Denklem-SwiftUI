...
struct Tariff2025: TariffProtocol {
    ...
    /// |------------------------|------------------|
    /// | First 300,000          | 300,000          |
    /// | Next 480,000           | 780,000          |
    /// | Next 780,000           | 1,560,000        |
    /// | Next 1,560,000         | 3,120,000        |
    /// | Next 4,680,000         | 7,800,000        |
    /// | Next 6,240,000         | 14,040,000       |
    /// | Next 12,480,000        | 26,520,000       |
    /// | Above                  | ∞                |
    let brackets: [(limit: Double, rate: Double)] = [
        (300000.0, 0.06),        // First 300,000 TL: 6%
        (780000.0, 0.05),        // 300,001 - 780,000 TL: 5%
        (1560000.0, 0.04),       // 780,001 - 1,560,000 TL: 4%
        (3120000.0, 0.03),       // 1,560,001 - 3,120,000 TL: 3%
        (7800000.0, 0.02),       // 3,120,001 - 7,800,000 TL: 2%
        (14040000.0, 0.015),     // 7,800,001 - 14,040,000 TL: 1.5%
        (26520000.0, 0.01),      // 14,040,001 - 26,520,000 TL: 1%
